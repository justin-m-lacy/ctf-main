import { Point, DisplayObject, Container, FederatedPointerEvent } from 'pixi.js';
...
export class Scrollbar extends Pane {
	...
	protected barClick(evt: FederatedPointerEvent) {
	...
	protected startDrag(evt: FederatedPointerEvent) {
	...
	protected onDrag(evt: FederatedPointerEvent) {
		...
		evt.getLocalPosition(this, this._dragPt);
	 ...
	 * @param {*} evt 
	 */
	protected endDrag(evt: FederatedPointerEvent) {
