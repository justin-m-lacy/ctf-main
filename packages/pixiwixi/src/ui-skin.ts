import { Text, Texture, FederatedPointerEvent, DisplayObject, TextStyle, LineStyle, FillStyle, GraphicsData } from 'pixi.js';
...
export class UiSkin extends PIXI.utils.EventEmitter<'skinChanged'> {
	 ...
	 * @param {*} [context=null]
	 */
	makeTextButton(str: string, onClick: (d: FederatedPointerEvent) => void, context?: any) {
